package math
{
	...
	public class Angle
	{
		...
		public static function azimuth(c0:Coordinate2, c1:Coordinate2):Number {
			if (Distance.p2p(c0, c1) == 0) return 0.0;
		...
		public static function includedAngle(c0:Coordinate2, c1:Coordinate2, c2:Coordinate2):Number {
			var az0:Number = azimuth(c1, c0);
			var az1:Number = azimuth(c1, c2);
			var iAngle:Number = az1 - az0;
			if (iAngle < 0.0) return iAngle + 2.0 * Math.PI;
			return iAngle;
		}
	}
}